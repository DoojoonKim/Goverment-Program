...
def step1_Popularity():
    # 데이터
    ratings = {
        'Dave': {'달콤한 인생': 5, '범죄도시': 3, '샤인': 3, '뽀롱뽀롱 뽀로로': 2, '머털도사': 1},
        'David': {'달콤한 인생': 5, '범죄도시': 1, '샤인': 4, '뽀롱뽀롱 뽀로로': 1, '머털도사': 4},
        'Alex': {'달콤한 인생': 0, '범죄도시': 4, '샤인': 5, '뽀롱뽀롱 뽀로로': 5, '머털도사': 2},
        'Andy': {'달콤한 인생': 2, '범죄도시': 1, '샤인': 5, '뽀롱뽀롱 뽀로로': 3, '머털도사': 5}
    }
